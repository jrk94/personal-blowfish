...
A factory, even one of the future, it is not a passive experience, it's a full on contact sport. Where hard decisions have to be made, where we train, plan and execute. But where execution is king.
...
Raw data is meaningless without context. A paint thickness reading of 73.22 μm tells you nothing. But `73.22 μm paint thickness on Lot-RTU-FRAME W, applied at PLATE PAINTING by Bob Operator using Gauge 0004` tells you a story.
...
The engineer is able to leverage his experience and his intuition and knowledge of the shopfloor and do an instant exploratory analysis, in a couple of minutes.
...
In order to use AI in manufacturing, it must:
